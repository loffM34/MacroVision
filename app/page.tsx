...
export default function Page() {
  ...
  return (
    <main className="text-center p-6 max-w-6xl mx-auto text-gray-900 dark:text-gray-100">
      {/* Food Guesser Section (Fixed at Top) */}
      <div className="flex flex-col items-center fixed top-4 left-1/2 transform -translate-x-1/2">
        <h1 className="text-xl font-semibold text-white">Food Guesser</h1>
        <a
          href="/testPage"
      ...
      <div className="mt-20"> {/* Adds spacing so content isn't hidden by fixed element */}
              ...
              <Card className="flex-1 bg-white dark:bg-white border border-black shadow-md">
                <CardContent className="p-6 font-sans text-black">
                  ...
                  <ul className="text-sm space-y-1 font-medium">
                    ...
                    <li>
                      <em>Carbs:</em> {nutritionData.carbs}
                    </li>
                    <li>
                      <em>Fiber:</em> {nutritionData.fiber}
                    </li>
                    <li>
